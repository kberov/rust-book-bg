## Да се `panic!`ьосваме или да НЕ се `panic!`ьосваме 

И така, как да решите кога да извикате `panic!` и кога да върнете`Result`? Когато кодът сам извика `panic!`, няма възможност да обработите грешката.
...
### Примери, полуготов код и тестове
...
### Когато знаете повече от компилатора
...
Сега, след като вече видяхте полезни начини, по които стандартната библиотека
използва обобщения в изброяванията `Option` и `Result`, ще поговорим за това
как работят обобщенията и как да ги използвате във вашия код.

...
### Създаване на нов низ

Много от действията за `Vec<T>` са приложими и за типа `String`, като започнем от функцията `new` за създаване на низ, както се вижда в пример 8-11.

```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-11/src/main.rs:here}}
```

<span class="caption">Пример 8-11: Създаване на нов празен `String`</span>
...
data in them, както е показано в пример 8-14.

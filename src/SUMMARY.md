#Езикът за програмиране Рѫст 

[Езикът за програмиране Рѫст](title-page.md)
...
- [Обработка на грешки](ch09-00-error-handling.md)
    - [Непоправими грешки с `panic!`](ch09-01-unrecoverable-errors-with-panic.md)
    - [Поправими грешки с `Result`](ch09-02-recoverable-errors-with-result.md)
    - [Да се `panic!`ьосваме или да НЕ се `panic!`ьосваме](ch09-03-to-panic-or-not-to-panic.md)
...
- [Appendix](appendix-00.md)
    ...
    - [F - Translations of the Book](appendix-06-translation.md)
        - [FA - Английско-български речник на понятитята](appendix-06-translation-bg.md)
        - [FA - Речник на понятията и английските им съответствия](appendix-06-translation2-bg.md)

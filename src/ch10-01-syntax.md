...
Рѫст постига това като извършва уеднаквяване на кода, използвайки обобщения по време на компилация.

*Уеднаквяване* е работата по превръщане на обобщения код в отделен код за всеки тип, който се използва по време на компилация.
is the process of turning generic
